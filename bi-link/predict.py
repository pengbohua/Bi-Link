...
# auto_config = AutoConfig.from_pretrained(args.eval_model_path)
# bert = BertModel(auto_config, add_pooling_layer=False)
...
class BertPredictor:
    ...
    def load(self, ckt_path, use_data_parallel=False):
        ...
        # self.model = PretrainedSimKGC(self.train_args, bert)
        print(self.model)
