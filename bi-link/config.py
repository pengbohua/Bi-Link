...
parser.add_argument('--eval-every-n-step', default=1000, type=int,
...
parser.add_argument('--eval-model-path', default='./checkpoint/fb15k237/model_last.mdl', type=str, metavar='N',
